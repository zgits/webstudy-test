<template>
  ...
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-select v-model="levelValue" class="filter-item" placeholder="难度" clearable @change="queryAll">
        <el-option v-for="item in level" :key="item.levelnum" :label="item.label" :value="item.levelnum" />

      </el-select>

      <el-select v-model="statusValue" class="filter-item" placeholder="状态" clearable @change="queryAll">
        <el-option v-for="item in statusArray" :key="item.status" :label="item.label" :value="item.status" />

      </el-select>

      <el-select v-model="typeValue" class="filter-item" placeholder="类别" clearable @change="queryAll">
        <el-option v-for="item in typeArray" :key="item.id" :label="item.typeName" :value="item.id" />
      ...
      <el-form v-if="active===0" ref="editFormRef" :model="editForm" label-width="70px" align="left">
        ...
        <el-form-item label="封面">
          <el-upload
            ...
            :file-list="files"
          >
            <el-image v-if="editForm.coverPath!=''" :src="editForm.coverPath" style="width: 146px;height: 146px" />
            <i v-if="editForm.coverPath==''" slot="default"class="el-icon-plus" />
        ...
        <el-col :span="8">
          <el-card class="box-card" style="width: 460px">
            ...
            <div class="component-item" style="height:420px;">
              ...
              <el-form v-if="(!this.showChild)&&(this.data.length>0)" label-width="50px">
                <el-form-item label="标题">
                  <el-input v-model="input" placeholder="请输入内容" @change="updateChapter" />

                </el-form-item>

              </el-form>
              <el-form v-if="this.showChild" label-width="50px">
                <el-form-item label="子标题">
                  <el-input v-model="input" placeholder="请输入内容" @change="changeValue" />
                ...
                <el-form-item label="视频资源">
                  ...
                  >
                    ...
                    />
                    <div slot="tip" class="el-upload__tip">只能上传视频文件在这里</div>
                  </el-upload>
...
export default {
  ...
  methods: {
    ...
    updateCourseWithoutFile() {
      this.editForm.typeId = this.typeIds.join(',')
      updateCourse(this.editForm)
    },
